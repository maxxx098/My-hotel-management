...
<div class="my-5 px-4">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-md-6 mb-5 px-4">
        <div class="bg-white rounded shadow p-4">
          ...
          <a href="https://goo.gl/maps/jFdoRUnTvq314zJy6" target="_blank" class="d-inline-block text-decoration-none text-dark mb-2">
            <i class="bi bi-geo-alt-fill"></i> 7862 Quezon Avenue 
          ...
          <a href="mailto: dineshslweb@gmail.com" class="d-inline-block mb-2 text-decoration-none text-dark"><i class="bi bi-envelope-fill"></i> villashotel@gmail.com</a>
      ...
      <div class="col-lg-6 col-md-6 mb-5 px-4">
        <div class="lala rounded shadow p-4">
          <form>
            ...
            <button type="submit" class="btn mt-3">Send</button>
          </form>
        </div>
      </div>
  </div>
