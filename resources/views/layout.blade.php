...
<head>
    ...
    <link href="{{asset('../myasset/css/style.css')}}" rel="stylesheet" type="text/css">
...
<body id="page-top" >
    ...
    <div id="wrapper" >
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="border: 1px solid #151828;">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">VILLA'S HOTEL<sup></sup></div>
            </a>
           ...
           <li class="nav-item">
            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
                <a class="nav-link @if(!request()->is('admin/staff*')) collapsed @endif" href="#" data-toggle="collapse" data-target="#StaffMaster"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-people-robbery"></i>
                    <span>Staff</span>
                </a>
            ...
            <li class="nav-item">
                <a class="nav-link @if(!request()->is('admin/testimonials*')) collapsed @endif" href="#" data-toggle="collapse" data-target="#TestimonialMaster"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-person-circle-question"></i>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- Main Content -->
            <div id="content" style="background-color:#151828;">

                <!-- Topbar -->
                <!-- Topbar -->
                <nav class="navbar navbar-expand  topbar mb-4 static-top shadow" style="background-color:#1b1f34; border-color:#1b1f34;">
            ...
            <!-- Footer -->
            <footer class="sticky-footer " style="background-color:#151828; border-color:#1b1f34;">
           <div class="line"><span class="divider"></span></div>
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span style="color: white;">Copyright &copy; Villa'sHotel 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
